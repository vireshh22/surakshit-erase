...
function App() {
    ...
    const handleNavigateBack = () => {
        if (status === 'drive_contents') {
            ...
            dispatch({ type: 'NAVIGATE_BACK_TO_DRIVE_SELECTION' });
        } else if (status === 'wiping') {
            // Don't allow navigation back during wiping
            return;
    ...
    const handleWipeComplete = (result) => {
        dispatch({ 
            type: 'WIPE_COMPLETE',
            payload: result
        });
    ...
    const handleWipeError = (errorMessage) => {
        dispatch({
            type: 'WIPE_ERROR',
                ...
                return (
                    <div className="error-state">
                        <div className="error-container">
                            ...
                            <p>{error}</p>
                            <button 
                                onClick={() => dispatch({ type: 'NAVIGATE_BACK_TO_DRIVE_SELECTION' })}
